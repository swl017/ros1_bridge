...
get_factory_vision_msgs__msg__Detection2DArray(const std::string & ros1_type_name, const std::string & ros2_type_name)
{
  ...
  if (
    (ros1_type_name == "vision_msgs/Detection2DArray" ||
     ros1_type_name == "") &&
    ros2_type_name == "vision_msgs/msg/Detection2DArray")
  {
    return std::make_shared<
      ...
      >
    >("vision_msgs/Detection2DArray", ros2_type_name);
  }
  return std::shared_ptr<FactoryInterface>();
}

std::unique_ptr<ServiceFactoryInterface>
get_service_factory_vision_msgs__msg__Detection2DArray(const std::string & ros_id, const std::string & package_name, const std::string & service_name)
{
  (void)ros_id;
  (void)package_name;
  (void)service_name;
  ...
  vision_msgs::msg::Detection2DArray & ros2_msg)
{
  ...
  {
    auto ros1_it = ros1_msg.detections.cbegin();
    auto ros2_it = ros2_msg.detections.begin();
    for (
      ;
      ros1_it != ros1_msg.detections.cend() &&
      ros2_it != ros2_msg.detections.end();
      ++ros1_it, ++ros2_it
    )
    {
  ...
  vision_msgs::Detection2DArray & ros1_msg)
{
  ...
  ros1_msg.detections.resize(ros2_msg.detections.size());
  // copy element wise since the type is different
  {
    auto ros2_it = ros2_msg.detections.cbegin();
    auto ros1_it = ros1_msg.detections.begin();
    for (
      ;
      ros2_it != ros2_msg.detections.cend() &&
      ros1_it != ros1_msg.detections.end();
      ++ros2_it, ++ros1_it
    )
    {
      // convert sub message element
...
>::internal_stream_translate_helper(
  ...
  vision_msgs::msg::Detection2DArray const & ros2_msg)
{
  ...
  streamVectorSize(stream, ros2_msg.detections);
...
Factory<
  vision_msgs::Detection2DArray,
  vision_msgs::msg::Detection2DArray
>::convert_2_to_1(const vision_msgs::msg::Detection2DArray& ros2_msg,
...
Factory<
  vision_msgs::Detection2DArray,
  vision_msgs::msg::Detection2DArray
>::length_2_as_1_stream(const vision_msgs::msg::Detection2DArray& ros2_msg)
{
