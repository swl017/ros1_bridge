...
get_factory_vision_msgs__msg__Detection3DArray(const std::string & ros1_type_name, const std::string & ros2_type_name)
{
  ...
  if (
    (ros1_type_name == "vision_msgs/Detection3DArray" ||
     ros1_type_name == "") &&
    ros2_type_name == "vision_msgs/msg/Detection3DArray")
  {
    return std::make_shared<
      ...
      >
    >("vision_msgs/Detection3DArray", ros2_type_name);
  }
  return std::shared_ptr<FactoryInterface>();
}

std::unique_ptr<ServiceFactoryInterface>
get_service_factory_vision_msgs__msg__Detection3DArray(const std::string & ros_id, const std::string & package_name, const std::string & service_name)
{
  (void)ros_id;
  (void)package_name;
  (void)service_name;
...
>::internal_stream_translate_helper(
  ...
  vision_msgs::msg::Detection3DArray const & ros2_msg)
{
...
Factory<
  vision_msgs::Detection3DArray,
  vision_msgs::msg::Detection3DArray
>::convert_2_to_1(const vision_msgs::msg::Detection3DArray& ros2_msg,
...
Factory<
  vision_msgs::Detection3DArray,
  vision_msgs::msg::Detection3DArray
>::length_2_as_1_stream(const vision_msgs::msg::Detection3DArray& ros2_msg)
{
